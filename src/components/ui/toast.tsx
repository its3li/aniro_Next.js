...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed left-0 right-0 z-[100] flex w-full max-h-screen flex-col p-4 bottom-[calc(4.5rem+var(--safe-area-bottom,0px)+0.5rem)] sm:left-auto sm:right-0 sm:max-w-[420px]",
      className
    )}
    {...props}
  />
