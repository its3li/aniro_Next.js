...
export const surahs: SurahInfo[] = [
  ...
  { number: 4, name: "سُورَةُ النِّسَاءِ", englishName: "An-Nisa", englishNameTranslation: "The Women", numberOfAyahs: 176, revelationType: "Medinan" },
  ...
  { number: 21, name: "سُورَةُ الْأَنْبِيَاءِ", englishName: "Al-Anbya", englishNameTranslation: "The Prophets", numberOfAyahs: 112, revelationType: "Meccan" },
  { number: 22, name: "سُورَةُ الْحَجِّ", englishName: "Al-Hajj", englishNameTranslation: "The Pilgrimage", numberOfAyahs: 78, revelationType: "Medinan" },
  ...
  { number: 34, name: "سُورَةُ سَبَأٍ", englishName: "Saba", englishNameTranslation: "Sheba", numberOfAyahs: 54, revelationType: "Meccan" },
  ...
  { number: 38, name: "سُورَةُ ص", englishName: "Sad", englishNameTranslation: "The Letter 'Saad'", numberOfAyahs: 88, revelationType: "Meccan" },
  ...
  { number: 42, name: "سُورَةُ الشُّورَىٰ", englishName: "Ash-Shuraa", englishNameTranslation: "The Consultation", numberOfAyahs: 53, revelationType: "Meccan" },
  ...
  { number: 49, name: "سُورَةُ الْحُجُرَاتِ", englishName: "Al-Hujurat", englishNameTranslation: "The Rooms", numberOfAyahs: 18, revelationType: "Medinan" },
  ...
  { number: 55, name: "سُورَةُ الرَّحْمَـٰنِ", englishName: "Ar-Rahman", englishNameTranslation: "The Beneficent", numberOfAyahs: 78, revelationType: "Medinan" },
  ...
  { number: 58, name: "سُورَةُ الْمُجَادِلَةِ", englishName: "Al-Mujadila", englishNameTranslation: "The Pleading Woman", numberOfAyahs: 22, revelationType: "Medinan" },
  ...
  { number: 61, name: "سُورَةُ الصَّفِّ", englishName: "As-Saf", englishNameTranslation: "The Ranks", numberOfAyahs: 14, revelationType: "Medinan" },
  { number: 62, name: "سُورَةُ الْجُمُعَةِ", englishName: "Al-Jumu'ah", englishNameTranslation: "The Congregation, Friday", numberOfAyahs: 11, revelationType: "Medinan" },
  ...
  { number: 66, name: "سُورَةُ التَّحْرِيمِ", englishName: "At-Tahrim", englishNameTranslation: "The Prohibtiion", numberOfAyahs: 12, revelationType: "Medinan" },
  ...
  { number: 69, name: "سُورَةُ الْحَاقَّةِ", englishName: "Al-Haqqah", englishNameTranslation: "The Reality", numberOfAyahs: 52, revelationType: "Meccan" },
  ...
  { number: 72, name: "سُورَةُ الْجِنِّ", englishName: "Al-Jinn", englishNameTranslation: "The Jinn", numberOfAyahs: 28, revelationType: "Meccan" },
  { number: 73, name: "سُورَةُ الْمُزَّمِّلِ", englishName: "Al-Muzzammil", englishNameTranslation: "The Enshrouded One", numberOfAyahs: 20, revelationType: "Meccan" },
  { number: 74, name: "سُورَةُ الْمُدَّثِّرِ", englishName: "Al-Muddaththir", englishNameTranslation: "The Cloaked One", numberOfAyahs: 56, revelationType: "Meccan" },
  ...
  { number: 78, name: "سُورَةُ النَّبَأِ", englishName: "An-Naba", englishNameTranslation: "The Tidings", numberOfAyahs: 40, revelationType: "Meccan" },
  ...
  { number: 83, name: "سُورَةُ الْمُطَفِّفِينَ", englishName: "Al-Mutaffifin", englishNameTranslation: "The Defrauding", numberOfAyahs: 36, revelationType: "Meccan" },
  ...
  { number: 86, name: "سُورَةُ الطَّارِقِ", englishName: "At-Tariq", englishNameTranslation: "The Nightcommer", numberOfAyahs: 17, revelationType: "Meccan" },
  ...
  { number: 92, name: "سُورَةُ اللَّيْلِ", englishName: "Al-Layl", englishNameTranslation: "The Night", numberOfAyahs: 21, revelationType: "Meccan" },
  ...
  { number: 98, name: "سُورَةُ الْبَيِّنَةِ", englishName: "Al-Bayyinah", englishNameTranslation: "The Clear Proof", numberOfAyahs: 8, revelationType: "Medinan" },
  ...
  { number: 104, name: "سُورَةُ الْهُمَزَةِ", englishName: "Al-Humazah", englishNameTranslation: "The Traducer", numberOfAyahs: 9, revelationType: "Meccan" },
  ...
  { number: 107, name: "سُورَةُ الْمَاعُونِ", englishName: "Al-Ma'un", englishNameTranslation: "The Small Kindnesses", numberOfAyahs: 7, revelationType: "Meccan" },
  ...
  { number: 109, name: "سُورَةُ الْكَافِرُونَ", englishName: "Al-Kafirun", englishNameTranslation: "The Disbelievers", numberOfAyahs: 6, revelationType: "Meccan" },
  ...
  { number: 114, name: "سُورَةُ النَّاسِ", englishName: "An-Nas", englishNameTranslation: "The Mankind", numberOfAyahs: 6, revelationType: "Meccan" }
];
